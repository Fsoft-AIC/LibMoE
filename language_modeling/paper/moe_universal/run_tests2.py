...
def get_info(tasks: str, patch_ckpt=None, save_dir: str = None, bs: Optional[int] = None):
    ...
    if not os.path.isfile(res_path):
        ...
        cmd = f"python3 main.py --name validate2 --log tb --restore {ckpt_path} --test_only 1 -reset 1 -lm.eval.enabled 1 {tasks} --keep_alive 0 {bs}"
