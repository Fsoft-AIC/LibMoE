...
@register_moe("lunacompetesmoev3")
class LunaCompeteSMoEv3(MoeLayer):
    ...
    def compute_moe(self, selected_experts, weights, results, x):
        ...
        for i, expert in enumerate(self.experts):
            ...
            results[batch_idx, token_idx] += weights[batch_idx, token_idx, topk_idx].unsqueeze(0).T * out_exp[:, 1:] + out_exp[:, 0].unsqueeze(1)
    ...
    def combine_competition_loss(self, selected_experts, affinity_softmax, gate_softmax, affinity_logits):
        ...
        # loss = routerloss * self.args.balance_loss_coef + zloss * self.args.router_z_loss_coef
        return loss
