...
class CompeteSMoEv30(MoeLayer):
    ...
    def forward(self, x, return_id_experts=False, is_vision=False):
        ...
        if self.gate.weight.requires_grad and self.current_steps >= self.step_warm and self.prob_flips[self.current_steps - self.step_warm].item() == 1:
            ...
            if self.gate.weight.requires_grad or return_id_experts: 
