...
import pandas as pd
import copy 
@register_moe("moeksv1")
class MoEKSv1(MoeLayer):
    def __init__(self, in_embed_dim=768, out_embed_dim=768, num_of_experts=4, num_selected=2, expert=None, args=None):
        ...
        self.gate_top = nn.Linear(num_of_experts - 1, self.num_selected, bias=False)
    ...
    def router_policy(self, x):
        ...
        weights_top = self.gate_top(gate_logits)
        weights_top = torch.sigmoid(weights_top)
