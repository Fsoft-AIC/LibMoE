...
# run tests
checkpoint_path="/cm/shared/anonymous/moeut_training_code/save/slimpajama_moe_no_attmoe_154M_standard_lb_large/checkpoint"
save_dir="/cm/shared/anonymous/moeut_training_code/save/slimpajama_moe_no_attmoe_154M_standard_lb_large/export"
bs=16
...
# bash /cm/shared/anonymous/moeut_training_code/scripts/eval_test3.sh
