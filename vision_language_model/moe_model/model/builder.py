...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", use_flash_attn=False, **kwargs):
    ...
    vision_params = count_parameters(vision_tower)
    projector_params = count_parameters(mm_projector)

    print(f"Vision Tower Params: {vision_params:,}")
    print(f"MM Projector Params: {projector_params:,}")
    print(f"Total: {vision_params + projector_params:,}")
