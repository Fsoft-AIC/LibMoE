...
| Date       | Release Notes                                                                                              |
|------------|------------------------------------------------------------------------------------------------------------|
| 2024-12-30 | - Release LibMoE v1.1:  <br> - Decrease training time by 70%, from approximately ~30h to ~9h.  <br> - Return more detailed information on MoE algorithms, including balancing loss, zloss, training time per step, FLOPs, language loss, total loss, aux loss, and more customizable metrics. |
